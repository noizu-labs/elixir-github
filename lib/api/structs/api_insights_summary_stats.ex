...
defmodule Noizu.Github.ApiInsightsSummaryStats do
  @moduledoc false
  defstruct [
  ...
  def from_json(json, _headers) when is_map(json) do
    %__MODULE__{
      rate_limited_request_count: Map.get(json, :rate_limited_request_count),
      total_request_count: Map.get(json, :total_request_count)
    }
  end

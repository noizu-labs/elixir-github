...
defmodule Noizu.Github.RepositoryRuleRulesetInfo do
  @moduledoc false
  defstruct [
    :ruleset_id,
    :ruleset_source,
  ...
  def from_json(json, _headers) when is_map(json) do
    %__MODULE__{
      ruleset_id: Map.get(json, :ruleset_id),
      ruleset_source: Map.get(json, :ruleset_source),
      ruleset_source_type: Map.get(json, :ruleset_source_type)
    }
  end

...
defmodule Noizu.Github.WebhookWorkflowJobInProgress do
  @moduledoc false
  defstruct [
    :action,
    :deployment,
  ...
  def from_json(json, _headers) when is_map(json) do
    %__MODULE__{
      ...
      deployment: Noizu.Github.Deployment.from_json(Map.get(json, :deployment)),
      ...
      workflow_job: Map.get(json, :workflow_job)
    }
  end

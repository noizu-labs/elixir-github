...
defmodule Noizu.Github.WebhookProjectColumnDeleted do
  @moduledoc false
  defstruct [
    :action,
    :enterprise,
  ...
  def from_json(json, _headers) when is_map(json) do
    %__MODULE__{
      ...
      project_column:
        Noizu.Github.WebhooksProjectColumn.from_json(Map.get(json, :project_column)),
      repository: Noizu.Github.NullableRepositoryWebhooks.from_json(Map.get(json, :repository)),

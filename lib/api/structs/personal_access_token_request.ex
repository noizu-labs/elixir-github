...
defmodule Noizu.Github.PersonalAccessTokenRequest do
  @moduledoc false
  defstruct [
    :created_at,
    :id,
  ...
  def from_json(json, _headers) when is_map(json) do
    %__MODULE__{
      ...
      permissions_added: Map.get(json, :permissions_added),
      permissions_result: Map.get(json, :permissions_result),
      permissions_upgraded: Map.get(json, :permissions_upgraded),
      repositories: Map.get(json, :repositories),

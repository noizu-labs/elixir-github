...
defmodule Noizu.Github.WebhookPersonalAccessTokenRequestCancelled do
  @moduledoc false
  defstruct [
    :action,
    :enterprise,
  ...
  def from_json(json, _headers) when is_map(json) do
    %__MODULE__{
      ...
      personal_access_token_request:
        Noizu.Github.PersonalAccessTokenRequest.from_json(
          Map.get(json, :personal_access_token_request)
        ),

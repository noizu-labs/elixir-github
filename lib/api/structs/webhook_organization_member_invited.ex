...
defmodule Noizu.Github.WebhookOrganizationMemberInvited do
  @moduledoc false
  defstruct [
    :action,
    :enterprise,
  ...
  def from_json(json, _headers) when is_map(json) do
    %__MODULE__{
      ...
      invitation: Map.get(json, :invitation),
      organization:
      ...
      user: Noizu.Github.WebhooksUser.from_json(Map.get(json, :user))
    }
  end

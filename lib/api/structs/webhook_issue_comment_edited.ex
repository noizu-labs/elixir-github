...
defmodule Noizu.Github.WebhookIssueCommentEdited do
  @moduledoc false
  defstruct [
    :action,
    :changes,
  ...
  def from_json(json, _headers) when is_map(json) do
    %__MODULE__{
      ...
      changes: Noizu.Github.WebhooksChanges.from_json(Map.get(json, :changes)),
      comment: Noizu.Github.WebhooksIssueComment.from_json(Map.get(json, :comment)),

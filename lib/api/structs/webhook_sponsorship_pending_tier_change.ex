...
defmodule Noizu.Github.WebhookSponsorshipPendingTierChange do
  @moduledoc false
  defstruct [
    :action,
    :changes,
  ...
  def from_json(json, _headers) when is_map(json) do
    %__MODULE__{
      ...
      changes: Noizu.Github.WebhooksChanges8.from_json(Map.get(json, :changes)),
      ...
      sponsorship: Noizu.Github.WebhooksSponsorship.from_json(Map.get(json, :sponsorship))
    }
  end

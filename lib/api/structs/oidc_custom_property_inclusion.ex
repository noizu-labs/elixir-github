...
defmodule Noizu.Github.OidcCustomPropertyInclusion do
  @moduledoc false
  defstruct [
  ...
  def from_json(json, _headers) when is_map(json) do
    %__MODULE__{
      custom_property_name: Map.get(json, :custom_property_name),
      inclusion_source: Map.get(json, :inclusion_source)
    }
  end

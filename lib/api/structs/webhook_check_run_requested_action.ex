...
defmodule Noizu.Github.WebhookCheckRunRequestedAction do
  @moduledoc false
  defstruct [
    :action,
    :check_run,
  ...
  def from_json(json, _headers) when is_map(json) do
    %__MODULE__{
      ...
      check_run: Noizu.Github.CheckRunWithSimpleCheckSuite.from_json(Map.get(json, :check_run)),
      ...
      requested_action: Map.get(json, :requested_action),
